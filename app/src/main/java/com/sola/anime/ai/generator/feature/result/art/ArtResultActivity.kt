...
class ArtResultActivity : LsActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /*
        val shareButton = findViewById<MaterialCardView>(R.id.cardShare)
        val downloadButton = findViewById<MaterialCardView>(R.id.cardDownload)
    ...
    private fun shareImage() {
        // Код для обработки кнопки "Поделиться"
        // Здесь можно вызвать диалоговое окно для выбора способа обмена изображением
        // или выполнить другую логику, связанную с поделиться изображением
    }

    private fun downloadImage() {
        // Код для обработки кнопки "Скачать"
        // Здесь можно выполнить логику для загрузки изображения на устройство пользователя
    }
